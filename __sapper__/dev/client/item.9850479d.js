...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 65, 8, 1443);
			attr_dev(div1, "class", "card shadow mb-4 svelte-1jtad21");
			add_location(div1, file, 64, 6, 1403);
			attr_dev(div2, "class", "col-md-8 col-sm-12");
			add_location(div2, file, 63, 4, 1363);
			attr_dev(div3, "class", "card-body");
			add_location(div3, file, 76, 8, 1727);
			attr_dev(div4, "class", "card shadow mb-4 svelte-1jtad21");
			add_location(div4, file, 75, 6, 1687);
			attr_dev(div5, "class", "col-md-4 col-sm-12");
			add_location(div5, file, 74, 4, 1647);
			attr_dev(div6, "class", "row");
			add_location(div6, file, 62, 2, 1340);
			attr_dev(div7, "class", "container");
			add_location(div7, file, 61, 0, 1313);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
